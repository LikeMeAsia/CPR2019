...
public class DoorBehaviour : MonoBehaviour
{
    ...
    {
        if (doorHandle) {
            doorHandle.onSelectEnter.AddListener(OnGrabbed);
            doorHandle.onSelectExit.AddListener(OnReleased);
        }
    }
    ...
    private void OnDisable()
    {
        if (doorHandle)
        {
            doorHandle.onSelectEnter.RemoveListener(OnGrabbed);
            doorHandle.onSelectExit.RemoveListener(OnReleased);
        }
    }
}
